Projet Ansible 3-Tiers – Emilien Raffault B3 Clermont
Description
...
L’idée est de créer une plateforme complète où le frontend communique avec le backend, lui-même connecté à la base.
Architecture
...
Cloner le projet :
git clone https://github.com/Emil0363000/projet-ansible-final-raffault.git
cd projet-ansible-final-raffault
...
Le frontend Nginx sert bien la page HTML statique.
...
Il a fallu créer un conteneur app dédié pour Node.js et monter correctement le code.
...
Le port 3000 était déjà utilisé localement, il a fallu passer à 3001.
Remarques finales
...
Malgré ces difficultés, je me suis donné à 200 % pour que l’infrastructure fonctionne de bout en bout, j’ai résolu les problèmes de PostgreSQL, Node.js et Docker autant que possible, et fourni une structure prête à l’emploi pour tout utilisateur.